...
# Define o esquema dos arquivos de dados
...
# Carrega os dados de repositórios
...
# Carrega os dados de vagas e salários
...
# Realiza os agrupamentos por linguagem
...
# Realiza o join com os dados de vagas e salários
df_grouped = grouped_df.join(df_jobs, on='linguagem').join(df_salary, on='linguagem')

# Obtém as linguagens e quantidades de vagas e salários
...
# Cria uma escala diferente para a quantidade de repositórios
ax2 = ax.twinx()
